...
#define UE_PROJECT_NAME Galaga_USFX_LAB2
#define UE_TARGET_NAME Galaga_USFX_LAB2Editor
#define UE_MODULE_NAME "Galaga_USFX_LAB2"
...
#define GALAGA_USFX_LAB2_API DLLEXPORT
